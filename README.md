...
<p align="left">Forward deployed engineering, software engineering and AI engineering roles, plus one or two long-term clients at a time on the Microsoft stack. What I enjoy most is being dropped in front of an unfamiliar system with a real problem attached to it.</p>
...
- Takeovers of undocumented production systems: read the estate, document it, keep shipping into it
...
- Migrated 25,790 Confluence objects across 132 spaces with zero loss in the vendor's own report, followed by three weeks of remediation

**Delivery record**

- Shipped six internal React applications and one client platform on a single Azure Static Web Apps and Functions template in six months
- Delivered a client's Raspberry Pi fleet management system solo in 149.5 hours across 21 tickets, a Power Apps and Dataverse console over live device telemetry, with the hardware bring-up and the operator training alongside it
- Logged about 1,310 hours across 45 client organisations and 22 projects since 2024
...
<ul>
  ...
  <li>LinkedIn: <a href="https://linkedin.com/in/pambidluis">linkedin.com/in/pambidluis</a></li>
</ul>
